...
var contractResolver = function contractResolver(tezos, address) {
  return tezos.contract.at(address);
};

function setContractResolver(resolver) {
...
function _toContract() {
  _toContract = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5(tezos, entry) {
    return runtime_1.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            return _context5.abrupt("return", typeof entry === "string" ? contractResolver(tezos, entry) : entry instanceof FoundDex ? entry.contract : entry);
...
var FoundDex = function FoundDex(contract, storage) {
...
function divestLiquidity(dex, shares, tokenValueMin, tezValueMin, opts) {
  return dex.methods.divestLiquidity(tezValueMin, tokenValueMin, shares).toTransferParams(fromOpOpts(undefined, opts));
}
...
function isUnsafeAllowanceChangeError(err) {
  try {
    ...
    return isUACErrorMessage(err == null ? void 0 : err.message) || (err == null ? void 0 : (_err$errors = err.errors) == null ? void 0 : _err$errors.some(function (e) {
      var _e$with, _e$with2, _e$with3, _e$with3$args, _e$with3$args$;

      return (e == null ? void 0 : (_e$with = e["with"]) == null ? void 0 : _e$with["int"]) === "23" || isUACErrorMessage(e == null ? void 0 : (_e$with2 = e["with"]) == null ? void 0 : _e$with2.string) || isUACErrorMessage(e == null ? void 0 : (_e$with3 = e["with"]) == null ? void 0 : (_e$with3$args = _e$with3.args) == null ? void 0 : (_e$with3$args$ = _e$with3$args[0]) == null ? void 0 : _e$with3$args$.string);
    }));
  } catch (_unused) {
    return false;
  }
...
function isUACErrorMessage(errMessage) {
  return Boolean(errMessage == null ? void 0 : errMessage.includes(Errors.UnsafeAllowanceChange));
}
...
var fa1_2 = {
  ...
  transfer: transfer,
  approve: approve,
  isUnsafeAllowanceChangeError: isUnsafeAllowanceChangeError
};
...
function isDexContainsLiquidity(dexStorage) {
  return !(new BigNumber(dexStorage.storage.tez_pool).isZero() || new BigNumber(dexStorage.storage.token_pool).isZero());
}
...
function _swap() {
  _swap = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(tezos, factories, fromAsset, toAsset, value, slippageTolerance, toAccount) {
    var fromAccount, dex$1, valueToMin, _dex, _valueToMin, halfSlippageTolerance, _yield$Promise$all, inputDex, outputDex, intermediateValueToMin, finalValueToMin;
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            dex$1 = _context.sent;
            valueToMin = withSlippage(estimateTezToToken(dex$1.storage, value), slippageTolerance);
            return _context.abrupt("return", [tezToTokenPayment(dex$1.contract, value, valueToMin, toAccount)]);
          ...
          case 16:
            _dex = _context.sent;
            _valueToMin = withSlippage(estimateTokenToTez(_dex.storage, value), slippageTolerance);
            return _context.abrupt("return", withTokenApprove(tezos, fromAsset, fromAccount, _dex.contract.address, value, [tokenToTezPayment(_dex.contract, value, _valueToMin, toAccount)]));
          ...
          case 25:
            ...
            intermediateValueToMin = withSlippage(estimateTokenToTez(inputDex.storage, value), halfSlippageTolerance);
            finalValueToMin = withSlippage(estimateTezToToken(outputDex.storage, intermediateValueToMin), halfSlippageTolerance);
            return _context.abrupt("return", withTokenApprove(tezos, fromAsset, fromAccount, inputDex.contract.address, value, [tokenToTezPayment(inputDex.contract, value, intermediateValueToMin, fromAccount), tezToTokenPayment(outputDex.contract, intermediateValueToMin, finalValueToMin, toAccount)]));
...
function estimateSwap(_x8, _x9, _x10, _x11, _x12, _x13) {
  return _estimateSwap.apply(this, arguments);
}

function _estimateSwap() {
  _estimateSwap = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(tezos, factories, fromAsset, toAsset, values, dexes) {
    var _dexes$inputDex, dex, _dexes$outputDex, _dex2, _dexes$inputDex2, _dexes$outputDex2, _yield$Promise$all2, inputDex, outputDex, intermediateTezValue, _intermediateTezValue;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if (!((_dexes$inputDex = dexes == null ? void 0 : dexes.inputDex) != null)) {
              _context2.next = 5;
              break;
            }

            _context2.t0 = _dexes$inputDex;
            _context2.next = 8;
            break;
          ...
          case 8:
            dex = _context2.t0;
            return _context2.abrupt("return", "outputValue" in values ? estimateTezToTokenInverse(dex.storage, values.outputValue) : estimateTezToToken(dex.storage, values.inputValue));
          ...
          case 12:
            ...
            if (!((_dexes$outputDex = dexes == null ? void 0 : dexes.outputDex) != null)) {
              _context2.next = 17;
              break;
            }

            _context2.t1 = _dexes$outputDex;
            _context2.next = 20;
            break;
          ...
          case 20:
            _dex2 = _context2.t1;
            return _context2.abrupt("return", "outputValue" in values ? estimateTokenToTezInverse(_dex2.storage, values.outputValue) : estimateTokenToTez(_dex2.storage, values.inputValue));
          ...
          case 24:
            ...
            _context2.next = 27;
            return Promise.all([(_dexes$inputDex2 = dexes == null ? void 0 : dexes.inputDex) != null ? _dexes$inputDex2 : findDex(tezos, factories, fromAsset), (_dexes$outputDex2 = dexes == null ? void 0 : dexes.outputDex) != null ? _dexes$outputDex2 : findDex(tezos, factories, toAsset)]);

          case 27:
            _yield$Promise$all2 = _context2.sent;
            inputDex = _yield$Promise$all2[0];
            outputDex = _yield$Promise$all2[1];
            ...
            intermediateTezValue = estimateTezToTokenInverse(outputDex.storage, values.outputValue);
            return _context2.abrupt("return", estimateTokenToTezInverse(inputDex.storage, intermediateTezValue));

          case 35:
            _intermediateTezValue = estimateTokenToTez(inputDex.storage, values.inputValue);
            return _context2.abrupt("return", estimateTezToToken(outputDex.storage, _intermediateTezValue));
...
function initializeLiquidity(_x14, _x15, _x16, _x17, _x18) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            if (!(dex$1 && isDexContainsLiquidity(dex$1.storage))) {
              _context3.next = 5;
              break;
            }
          ...
          case 7:
            ...
            return _context3.abrupt("return", withTokenApprove(tezos, token, fromAccount, dex$1.contract.address, tokenValue, [initializeExchange(dex$1.contract, tokenValue, tezValue)]));
...
function addLiquidity(_x19, _x20, _x21) {
...
function _addLiquidity() {
  _addLiquidity = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4(tezos, dex$1, values) {
    var token, tokenValue, tezValue, fromAccount;
    return runtime_1.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return toFoundDex(tezos, dex$1);

          case 2:
            dex$1 = _context4.sent;

            if (isDexContainsLiquidity(dex$1.storage)) {
              _context4.next = 5;
              break;
            }
          ...
          case 5:
            token = getDexToken(dex$1.storage);
            ...
            if ("tokenValue" in values && "tezValue" in values) {
              ...
              tokenValue = values.tokenValue;
              tezValue = estimateTezInToken(dex$1.storage, tokenValue);
            } else {
              tezValue = values.tezValue;
              tokenValue = estimateTokenInTez(dex$1.storage, tezValue);
            }
          ...
          case 9:
            ...
            return _context4.abrupt("return", withTokenApprove(tezos, token, fromAccount, dex$1.contract.address, tokenValue, [investLiquidity(dex$1.contract, tokenValue, tezValue), withdrawProfit(dex$1.contract, fromAccount)]));
...
function removeLiquidity(_x22, _x23, _x24, _x25) {
...
function _removeLiquidity() {
  _removeLiquidity = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5(tezos, dex$1, lpTokenValue, slippageTolerance) {
    var lpToken, tokenValueMin, tezValueMin, fromAccount;
    return runtime_1.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
          ...
          case 2:
            dex$1 = _context5.sent;
            lpToken = toLPToken(dex$1.contract, dex$1.storage);
            tokenValueMin = withSlippage(estimateTokenInShares(dex$1.storage, lpTokenValue), slippageTolerance);
            tezValueMin = withSlippage(estimateTezInShares(dex$1.storage, lpTokenValue), slippageTolerance);
            _context5.next = 8;
            return tezos.signer.publicKeyHash();

          case 8:
            fromAccount = _context5.sent;
            return _context5.abrupt("return", withTokenApprove(tezos, lpToken, fromAccount, dex$1.contract.address, lpTokenValue, [divestLiquidity(dex$1.contract, lpTokenValue, tokenValueMin, tezValueMin)]));
...
function getLiquidityShare(_x26, _x27, _x28) {
...
function _getLiquidityShare() {
  _getLiquidityShare = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee6(tezos, dex, account) {
    var val, unfrozen, frozen;
    return runtime_1.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return toFoundDex(tezos, dex);

          case 2:
            dex = _context6.sent;
            _context6.next = 5;
            return dex.storage.storage.ledger.get(account);
...
function estimateReward(_x29, _x30, _x31) {
...
function _estimateReward() {
  _estimateReward = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee7(tezos, dex, account) {
    ...
    var storage, _yield$Promise$all3, rewards, shares, reward, _rewards$reward_paid, now, periodFinish, lastUpdateTime, rewardsTime, newReward, periodsDuration, rewardPerSec, rewardPerShare, totalShares;
...
function withdrawReward(_x32, _x33, _x34) {
...
function voteForBaker(_x35, _x36, _x37, _x38) {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 6:
            ...
            voter = fromAccount;
            return _context9.abrupt("return", withTokenApprove(tezos, lpToken, fromAccount, dex$1.contract.address, lpTokenValue, [vote(dex$1.contract, voter, bakerAddress, lpTokenValue)]));
...
function vetoCurrentBaker(_x39, _x40, _x41) {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 6:
            ...
            voter = fromAccount;
            return _context10.abrupt("return", withTokenApprove(tezos, lpToken, fromAccount, dex$1.contract.address, lpTokenValue, [veto(dex$1.contract, voter, lpTokenValue)]));
...
function isDexExistAndContainsLiquidity(_x42, _x43, _x44) {
    ...
    return runtime_1.wrap(function _callee11$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 5:
            return _context11.abrupt("return", isDexContainsLiquidity(dex.storage));
...
function _findDexNonStrict() {
  _findDexNonStrict = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee12(tezos, factories, token) {
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          ...
          case 6:
            ...
            if (!(_context12.t0 instanceof DexNotFoundError)) {
              _context12.next = 10;
              break;
            }
...
function _findDex() {
  _findDex = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee14(tezos, _ref, token) {
    var fa1_2Factory, fa2Factory, factories, tokenAddress, t2dexQuery, dexes;
    return runtime_1.wrap(function _callee14$(_context14) {
      while (1) {
        switch (_context14.prev = _context14.next) {
          case 0:
            fa1_2Factory = _ref.fa1_2Factory, fa2Factory = _ref.fa2Factory;
            factories = isFA2Token(token) ? fa2Factory : fa1_2Factory;
            ...
            t2dexQuery = isFA2Token(token) ? [tokenAddress, token.id] : tokenAddress;
            dexes = [];
            _context14.next = 8;
            return Promise.all(factories.map( /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee13(factory) {
                var facContract, facStorage, dexAddress, dexContract, dexStorage;
                return runtime_1.wrap(function _callee13$(_context13) {
                  while (1) {
                    switch (_context13.prev = _context13.next) {
                      case 0:
                        _context13.next = 2;
                        return toContract(tezos, factory);

                      case 2:
                        facContract = _context13.sent;
                        _context13.next = 5;
                        return facContract.storage();

                      case 5:
                        facStorage = _context13.sent;
                        _context13.next = 8;
                        return facStorage.token_to_exchange.get(t2dexQuery);

                      case 8:
                        dexAddress = _context13.sent;
                        ...
                        _context13.next = 12;
                        return toContract(tezos, dexAddress);

                      case 12:
                        dexContract = _context13.sent;
                        _context13.next = 15;
                        return dexContract.storage();

                      case 15:
                        dexStorage = _context13.sent;
          ...
          case 8:
            ...
            return _context14.abrupt("return", dexes.sort(chooseDex)[0]);
          ...
          case 12:
            ...
            return _context14.abrupt("return", dexes[0]);
...
function toFoundDex(_x51, _x52) {
  return _toFoundDex.apply(this, arguments);
}

function _toFoundDex() {
  _toFoundDex = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee15(tezos, dex) {
      ...
      while (1) {
        switch (_context15.prev = _context15.next) {
          case 0:
            ...
            return _context15.abrupt("return", dex);
          ...
          case 7:
            storage = _context15.sent;
            return _context15.abrupt("return", new FoundDex(contract, storage));
...
function withTokenApprove(_x53, _x54, _x55, _x56, _x57, _x58) {
  return _withTokenApprove.apply(this, arguments);
}

function _withTokenApprove() {
  _withTokenApprove = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee16(tezos, token, from, to, value, transfers) {
      ...
      while (1) {
        switch (_context16.prev = _context16.next) {
          ...
          case 2:
            ...
            return _context16.abrupt("return", [updateOperators(tokenContract, [{
              type: "add_operator",
              from: from,
              to: to,
              tokenId: token.id
          ...
          case 12:
            ...
            if (isUnsafeAllowanceChangeError(_context16.t0)) {
              resetApprove = true;
            }

          case 15:
            return _context16.abrupt("return", resetApprove ? [approve(tokenContract, to, 0), approveParams].concat(transfers) : [approveParams].concat(transfers));
...
function chooseDex(a, b) {
  return new BigNumber(b.storage.storage.tez_pool).minus(a.storage.storage.tez_pool).toNumber();
}
/**
 * Errors
 */
...
export { ACCURANCY_MULTIPLIER, dex as Dex, DexAlreadyContainsLiquidity, DexNotContainsLiquidity, DexNotFoundError, fa1_2 as FA1_2, fa2 as FA2, FEE_FACTOR, factory as Factory, FoundDex, ReadOnlySigner, VETO_PERIOD, VOTING_PERIOD, addLiquidity, assertNat, batchify, chooseDex, estimateReward, estimateSharesInTez, estimateSharesInToken, estimateSwap, estimateTezInShares, estimateTezInToken, estimateTezToToken, estimateTezToTokenInverse, estimateTokenInShares, estimateTokenInTez, estimateTokenToTez, estimateTokenToTezInverse, estimateTransfers, findDex, findDexNonStrict, fromOpOpts, getDexToken, getLiquidityShare, initializeLiquidity, isDexContainsLiquidity, isDexExistAndContainsLiquidity, isFA2Token, isTezAsset, isTokenAsset, removeLiquidity, setContractResolver, swap, toContract, toContractAddress, toFoundDex, toLPToken, vetoCurrentBaker, voteForBaker, withSlippage, withTokenApprove, withdrawReward };
