...
import { ContractAbstraction, ContractProvider, TezosToolkit, Wallet, WalletOperationBatch } from "@taquito/taquito";
...
export declare type Contract = ContractAbstraction<ContractProvider | Wallet>;
export declare type ContractOrAddress = Contract | string;
export declare type OperationOptions = Partial<{
    source: string;
    fee: BigNumber.Value;
    storageLimit: BigNumber.Value;
    gasLimit: BigNumber.Value;
}>;
export declare type Batch = OperationBatch | WalletOperationBatch;
...
export declare type Asset = Token | "tez";
...
export declare type ContractResolver = (tezos: TezosToolkit, address: string) => Promise<Contract>;
