...
exports.preparePairingAlert = function (id, shadowRoot, pairingPayload) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            case 1:
                ...
                closeFn = function (event) {
                    if (event.data === "closeAlert-" + id) {
                        MockWindow_1.windowRef.removeEventListener('message', messageFn);
                        MockWindow_1.windowRef.removeEventListener('message', closeFn);
                    }
                };
                MockWindow_1.windowRef.addEventListener('message', messageFn);
                MockWindow_1.windowRef.addEventListener('message', closeFn);
